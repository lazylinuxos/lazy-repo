...
GH_REPO="AvengeMedia/dankcalendar"
...
curl -L "https://github.com/${GH_REPO}/releases/download/v${VERSION}/dankcalendar-${VERSION}.tar.gz" -o "${VERSION}.tar.gz"
