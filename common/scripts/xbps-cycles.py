...
def enum_depends(pkg, xbpsdir, cachedir):
	...
	be a path to a lazy-pkgs repository. Dependencies will be
...
def find_cycles(depmap, xbpsdir):
	...
	The argument xbpsdir should be a path to the root of a lazy-pkgs
...
if __name__ == '__main__':
	...
	parser.add_argument('-d', '--directory',
			default=None, help='Path to lazy-pkgs repo')
